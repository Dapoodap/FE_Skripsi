  ...
  const handleDelete = async () => {
    ...
    if (sewa) {
      const sewaResponse = await axios.delete(
        `https://be-skripsi-6v25wnffuq-uc.a.run.app/inv/${idinvoice.substring(
          4
        )}`,
        {
          headers: {
      ...
      const sewaResponse = await axios.delete(
        `https://be-skripsi-6v25wnffuq-uc.a.run.app/dp/${idinvoice.substring(
          4
        )}`,
        {
          headers: {
  ...
  const handleApprove = async () => {
    ...
    if (sewa) {
      const sewaResponse = await axios.put(
        `https://be-skripsi-6v25wnffuq-uc.a.run.app/inv/acc/${idinvoice.substring(
          4
        )}`,
        null,
        {
      ...
      const sewaResponse = await axios.put(
        `https://be-skripsi-6v25wnffuq-uc.a.run.app/dp/acc/${idinvoice.substring(
          4
        )}`,
        null,
        {
          ...
          <Form>
            ...
            <Form.Group controlId="bukti">
              ...
              <div style={infoContainerStyle}>
                ...
                <div>
                  <h5>List Barang Bawaan:</h5>
                  {dataDp &&
                    dataDp.tambahanBawaan &&
                    JSON.parse(dataDp.tambahanBawaan).map((barang, index) => (
                      <li key={index}>{barang}</li>
                    ))}
                </div>
